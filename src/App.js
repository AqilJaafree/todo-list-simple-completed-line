...
export default function App() {
  ...
  function add(e) {
    setTodos([...todos, text]); // Spread operator is used to create a new array with existing todos and the new text
  }
    ...
    <div className="App">
      ...
      <ul>
        ...
        {todos.map((data, index) => (
          ...
          />
            {data}
            {/* Button to remove the corresponding todo item, with 'remove' function as the onClick event handler */}
